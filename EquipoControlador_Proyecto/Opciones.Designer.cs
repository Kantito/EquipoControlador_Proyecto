namespace EquipoControlador_Proyecto
{
    partial class Opciones
    {
        ...
        {
            Nombre_SO = new Button();
            Plataforma_SO = new Button();
            Version_SO = new Button();
            Nombre_Equipo = new Button();
            Info_Procesador = new Button();
            Total_RAM = new Button();
            Lista_Unidades_Disco_Duro = new Button();
            Resolucion_pantalla = new Button();
            Nombre_Usuario = new Button();
            Zona_horaria = new Button();
            Fecha_Hora = new Button();
            Procesos_ejecucion = new Button();
            Captura_Pantalla = new Button();
            Enviar_mensaje = new Button();
            Subir_volumen = new Button();
            Bajar_volumen = new Button();
            Silenciar_sonido = new Button();
            Apagar_equipo = new Button();
            Reiniciar_equipo = new Button();
            ...
            Nombre_SO.Click += Nombre_SO_Click;
            // 
            // Plataforma_SO
            // 
            ...
            Resolucion_pantalla.Click += Resolucion_pantalla_Click;
            // 
            // Nombre_Usuario
            // 
            ...
            Zona_horaria.Click += Zona_horaria_Click;
            // 
            // Fecha_Hora
            // 
            ...
            Fecha_Hora.Click += Fecha_Hora_Click;
            // 
            // Procesos_ejecucion
            // 
            ...
            Cerrar_sesion_Windows.Click += Cerrar_sesion_Windows_Click;
            // 
            // Finalizar_Procesos
            // 
            ...
            Finalizar_Procesos.Click += Finalizar_Procesos_Click;
            // 
            // Desconectar
            // 
            ...
            Controls.Add(Reiniciar_equipo);
            Controls.Add(Apagar_equipo);
            Controls.Add(Silenciar_sonido);
            Controls.Add(Bajar_volumen);
            Controls.Add(Subir_volumen);
            Controls.Add(Enviar_mensaje);
            Controls.Add(Captura_Pantalla);
            Controls.Add(Procesos_ejecucion);
            Controls.Add(Fecha_Hora);
            Controls.Add(Zona_horaria);
            Controls.Add(Nombre_Usuario);
            Controls.Add(Resolucion_pantalla);
            Controls.Add(Lista_Unidades_Disco_Duro);
            Controls.Add(Total_RAM);
            Controls.Add(Info_Procesador);
            Controls.Add(Nombre_Equipo);
        ...
        private Button Nombre_SO;
        private Button Plataforma_SO;
        private Button Version_SO;
        private Button Nombre_Equipo;
        private Button Info_Procesador;
        private Button Total_RAM;
        private Button Lista_Unidades_Disco_Duro;
        private Button Resolucion_pantalla;
        private Button Nombre_Usuario;
        private Button Zona_horaria;
        private Button Fecha_Hora;
        private Button Procesos_ejecucion;
        private Button Captura_Pantalla;
        private Button Enviar_mensaje;
        private Button Subir_volumen;
        private Button Bajar_volumen;
        private Button Silenciar_sonido;
        private Button Apagar_equipo;
        private Button Reiniciar_equipo;
